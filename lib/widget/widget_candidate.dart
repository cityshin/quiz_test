...
class CandWidget extends StatefulWidget {
  VoidCallback tap;       //부모 위젯에서 지정한 onTap을 전달해주는 기능
  String text;
  int index;
  double width;
  bool answerState;

  CandWidget({super.key, required this.tap,required this.text, required this.index, required this.width, required this.answerState});
